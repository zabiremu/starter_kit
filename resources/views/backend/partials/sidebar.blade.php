    ...
    <ul class="nav">
                ...
                <div class="profile-pic">
                    <div class="count-indicator">
                        <img class="img-xs rounded-circle "
                            src="@isset(Auth::user()->image)  {{ Auth::user()->image ? asset(Auth::user()->image) : 'https://api.dicebear.com/8.x/adventurer/svg?seed=' . Auth::user()->name }} @endisset"
                            alt="">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="settings">
                ...
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('companyinformation.index') }}">Company
                            Information</a></li>
                </ul>

                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('mailsettings.index') }}">Mail
                            Settings</a></li>
                </ul>
            </div>
        </li>
